...
export const FooterSection = ({ id }) => (
	<Section id={id} className='scrollreveal'>
		<StyledH3 className='scrollreveal' color={COLORS.WHITE} align='center'>Let's get in touch!</StyledH3>
		...
		<TYPOGRAPHY.S2 color={COLORS.GREY_5} align='center'>&copy; 2019 - 2024 James Li, All Rights Reserved.</TYPOGRAPHY.S2>
		<StyledSocials small />
