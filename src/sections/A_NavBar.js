...
import { COLORS, COMMON_STYLES, NAV_REVEAL, TYPOGRAPHY } from '../atoms';
        ...
        return (
            <CollapsiblesDiv isBlueNav={isBlueNav} isMenuVisible={isMenuVisible}>
                <Scrollspy
                    ...
                    items={['home', 'about', 'skills', 'portfolio', 'experiences', 'outside', 'my_system']}
                >
                    <li></li>
                    <ListItem>
                    ...
                    <ListItem>
                        <NavButton refID="my_system" text="My System" />
                    </ListItem>
                </Scrollspy>
            </CollapsiblesDiv>
        );
...
const Nav = styled.nav`
    ...
    animation: ${(props) => (props.isBlueNav ? NAV_REVEAL : 'none')} 0.3s ease-out 0s;
`;
